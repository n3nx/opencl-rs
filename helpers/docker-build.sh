...
######################################################################
#
# build.sh - Docker image building helper.
#
...
docker push diabloxenon/opencl:0.1.0-amd64
docker push diabloxenon/opencl:0.1.0
docker push diabloxenon/opencl:latest
